...
public class ObjectFactory {
    ...
    private final static QName _Despedir_QNAME = new QName("http://webservice/", "despedir");
    private final static QName _DespedirResponse_QNAME = new QName("http://webservice/", "despedirResponse");
    private final static QName _Saludar_QNAME = new QName("http://webservice/", "saludar");
    private final static QName _SaludarResponse_QNAME = new QName("http://webservice/", "saludarResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "despedir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "despedirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "saludar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "saludarResponse")
