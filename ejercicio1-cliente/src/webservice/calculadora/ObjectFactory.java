 ...
 * generated in the webservice.calculadora package. 
...
public class ObjectFactory {
    ...
    private final static QName _Dividir_QNAME = new QName("calculadora.webservice", "dividir");
    private final static QName _DividirResponse_QNAME = new QName("calculadora.webservice", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("calculadora.webservice", "multiplicar");
    private final static QName _MultiplicarResponse_QNAME = new QName("calculadora.webservice", "multiplicarResponse");
    private final static QName _Sum_QNAME = new QName("calculadora.webservice", "sum");
    private final static QName _SumResponse_QNAME = new QName("calculadora.webservice", "sumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice.calculadora
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "calculadora.webservice", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "calculadora.webservice", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "calculadora.webservice", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "calculadora.webservice", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "calculadora.webservice", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "calculadora.webservice", name = "sumResponse")
